...
module.exports = {
    ...
    'rules': {
        'react/default-props-match-prop-types': 0, // We does not use default props.
        ...
        'react/no-redundant-should-component-update': 0, // we'll reconsider this option when we begin to use `PureComponent`.
